...
Moreover, the specific formulation considered in this paper is stochastic multi-armed bandits, in which the arm rewards are generated from a single reward distribution.
...
Also, other algorithms and more extensive discussion on the multi-armed bandits can be found in \cite{Lattimore2019}.
