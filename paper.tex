...
Moreover, the specific formulation considered in this paper is a stochastic multi-armed bandit, in which the arm rewards are generated from a single reward distribution.
